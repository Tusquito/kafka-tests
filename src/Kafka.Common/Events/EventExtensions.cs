...
public static class EventExtensions
{
    ...
    public static Dictionary<EventKind, Type> ScanEvents() => AppDomain.CurrentDomain.GetAssemblies().SelectMany(a =>
    ...
    public static EventKind FindEventKind(this Headers headers)
    {
        ...
        {
            return EventKind.K_EVENT_UNKNOWN;
        }
    ...
    {
        public Type FindEventType(EventKind kind) => events[kind];
